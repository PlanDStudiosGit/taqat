    ...
    <center class="wrapper">
        <table width="100%" class="main">
            ...
            <tr style="text-align: left;">
                <td>
                    {{-- <a href="#"><img src="{{asset('images/taqat_logo.png')}}" alt="" width="200px"></a> --}}
                </td>
            </tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <P
                                                            style="font-size: 23px; font-weight: bold;  font-family: ubuntu;">
                                                            INVOICE</P>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <td>
                                            ...
                                            <table width="100%" class="content-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $invoiceData['labor_sponsorship_fee'] }}</td>
                                                    </tr>
                                            ...
                                            <table width="100%" class="content-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>{{ $invoiceData['taqat_percent'] }}%</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            <table style="padding: 10px; color:black; text-align: right;"
                                                ...
                                                <tr>
                                                    <td>
                                                        <p>SUBTOTAL : {{ $invoiceData['labor_sponsorship_fee'] * ($invoiceData['taqat_percent'] / 100) +  $invoiceData['labor_sponsorship_fee'] }}
                                                        </p>
                                            ...
                                            <table style="padding: 10px; ">
                                                <tr>
                                                    <td>Once invoice paid , please send pay slip to the
                                                        following WhatsApp number : {{$invoiceData['taqat_whatsapp']}}</td>
                                                </tr>
