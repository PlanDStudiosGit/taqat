        ...
        <form class="myform" method="POST" action="{{ !empty($service)? route('admin.pages.update', ['id' => $service->id]) : route('admin.pages.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="title" class="form-control " rows="5" value="{{ @$service->title }}">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="slug" class="form-control" rows="5" value="{{ @$service->slug }}">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="description" class="form-control tinymceeditor" rows="5">
